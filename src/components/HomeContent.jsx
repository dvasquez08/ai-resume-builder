  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-cover bg-center flex flex-col items-center justify-center text-center px-6">
        <h1 className="text-black mt-24 font-sans font-light text-2xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 my-10">
          ...
          <div className="max-w-lg">
            <h2 className="text-black mt-16 font-sans text-xl font-light sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl text-center">
              How It Works
            </h2>
            <ol className="list-decimal list-inside space-y-4 text-black px-6 mt-4">
              <li>
          ...
          <div>
            <h2 className="text-black mt-16 font-sans font-light text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl text-center">
              Benefits
            </h2>
            <ul className="list-disc list-inside space-y-4 text-black px-6 mt-4">
              <li>
        ...
        <p className="text-black px-6 mt-4 font-bold max-w-lg">
          Future Updates:
        </p>
        <ul className="list-disc list-inside space-y-4 text-black mt-4 mx-6">
          <li>
        ...
        <p className="text-black px-6 mt-4 max-w-lg">Stay tuned for updates!</p>
      </div>
